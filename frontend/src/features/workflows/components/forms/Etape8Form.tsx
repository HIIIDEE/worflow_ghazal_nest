        ...
        <Box>
            <Paper sx={{ p: 3, bgcolor: '#f8fafc', border: '1px solid #e2e8f0' }} elevation={0}>
                ...
                <Typography variant="body2" sx={{ mb: 3, color: '#64748b' }}>
                    Vérifiez chaque point lors du passage du tuyau haute pression
                </Typography>
                        ...
                        <Grid size={{ xs: 12, md: 6 }} key={index}>
                            ...
                            >
                                <Paper
                                    sx={{
                                        p: 2,
                                        bgcolor: controles[controle] ? '#f3e8ff' : 'white',
                                        border: controles[controle] ? '2px solid #7c3aed' : '1px solid #e2e8f0',
                                        transition: 'all 0.2s',
                                        height: '100%',
                                        '&:hover': !disabled ? {
                                            borderColor: '#7c3aed',
                    ...
                    >
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Typography variant="body2" sx={{ color: '#059669', fontWeight: 600 }}>
                                Toutes les opérations du passage du tuyau HP Ø6 ont été effectuées
                            </Typography>
                        </Box>
                    </Box>
                )}
