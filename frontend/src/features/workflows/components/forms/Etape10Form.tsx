...
export default function Etape10Form({ formData, onChange, disabled = false }: Etape10FormProps) {
            ...
            <Paper sx={{ p: 3, bgcolor: '#f8fafc', border: '1px solid #e2e8f0' }} elevation={0}>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <SettingsInputComponentIcon sx={{ mr: 1, color: '#059669' }} />
                ...
                <Typography variant="body2" sx={{ mb: 3, color: '#64748b' }}>
                    Vérifiez chaque point lors de l'installation de la centrale GPL
                </Typography>
                    ...
                    >
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Typography variant="body2" sx={{ color: '#059669', fontWeight: 600 }}>
                                Toutes les opérations de la centrale GPL ont été effectuées
                            </Typography>
                        </Box>
                    </Box>
                )}
